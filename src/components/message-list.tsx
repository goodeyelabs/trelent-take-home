//  ======
//  List of chat messages per active chat session
//  ======
...
export default function MessageList() {
  ...
  if (list[activeSession]) {
    return (
      <div className='grid py-0 pb-6 lg:pb-16 items-start content-start w-full px-5 sm:px-8 md:px-12 lg:px-16 xl:px-32 bg-white dark:bg-redax'>
        {
