    ...
    <div className='grid px-2.5 md:px-3 xl:px-4 lg:pb-[calc(var(--footer-height)/2)] bg-white dark:bg-redax'>
      <div className='grid py-0 pb-6 lg:pb-3 content-start w-full px-5 sm:px-8 md:px-12 lg:px-16 xl:px-32 bg-white dark:bg-redax'>
        <div className='grid items-center py-2.5 px-5 pr-3 md:px-5 md:pr-3 xl:px-3 xl:pl-5 drop-shadow-sm bg-white dark:bg-redax-lighter shadow-[inset_0_0_0_1px] shadow-neutral-300 dark:shadow-white/5 rounded-[30px]'>
          <div className='grid gap-3 grid-flow-col grid-cols-[auto_1fr_auto] md:grid-cols-[auto_1fr_auto] items-end'>
            <ChatBubbleLeftIcon className='grid w-6 h-6 mb-[8px] text-neutral-500' />
            <TextareaAutosize
              ref={textareaRef}
              autoFocus
              ...
              className='grid w-full resize-none pb-2 text-[16px] md:text-[16px] tracking-tight bg-transparent font-normal text-mulberry-dark dark:text-neutral-300 placeholder:text-neutral-400 placeholder: appearance-none outline-none overflow-y-hidden'>
            </TextareaAutosize>
