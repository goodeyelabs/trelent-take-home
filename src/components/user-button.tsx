...
import { ArrowLeftOnRectangleIcon, ArrowPathIcon, UserIcon } from "@heroicons/react/24/outline"
...
export default function UserButton({ mode }: { mode?: string }) {
  ...
  return (
    <div className='grid relative z-20 select-none'>
      <Button customRounded='rounded-full' dontHideText onClick={() => handleShowMenu()} text={mode && 'Settings'} icon={<UserIcon />} />
      {
